...
<nav class="tabs" aria-label="Filtro de usuarios">
	<a href="/gestor/usuarios?{qParam('todos')}" class:active={data.vista === 'todos'}>
		Todos <span>{data.counts.todos}</span>
	</a>
	<a href="/gestor/usuarios?{qParam('en_curso')}" class:active={data.vista === 'en_curso'}>
		Con trámites en curso <span>{data.counts.en_curso}</span>
	</a>
	<a href="/gestor/usuarios?{qParam('finalizados')}" class:active={data.vista === 'finalizados'}>
		Trámites finalizados <span>{data.counts.finalizados}</span>
	</a>
	<a href="/gestor/usuarios?{qParam('sin_tramites')}" class:active={data.vista === 'sin_tramites'}>
