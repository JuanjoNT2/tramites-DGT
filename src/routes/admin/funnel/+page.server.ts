...
function emptyFunnel(): FunnelStep[] {
	return [
		{ key: 'form_started', label: 'Formulario iniciado', count: 0, dropOffPct: null },
		{ key: 'form_submitted', label: 'Formulario enviado', count: 0, dropOffPct: null },
		{ key: 'payment_started', label: 'Pago iniciado', count: 0, dropOffPct: null },
		{ key: 'payment_completed', label: 'Pago completado', count: 0, dropOffPct: null }
	];
}
